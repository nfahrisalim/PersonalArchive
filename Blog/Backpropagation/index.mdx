...
2. Here, we use the **Chain Rule** (yep, good old calculus \:D).
...
We're going to try predicting a value. For the initial weights and biases, I'll just pick some nice, easy-to-read numbers. \:D
